...
@AttributeOverride(name = "id", column = @Column(name = "tax_id"))  /**Quando Extendemos esta Class AbstractEntity, recebemos por Herença os Atributos,e temos que OVERRIDE este atributos, pos ito que temos esta @notação*/
